...
#from keras import keras_applications
...
def build_saved_model(build_sess, output_dir):
    ...
    input_op_ph1 = build_sess.graph.get_operation_by_name('Placeholder_1')
    input_op_ph2 = build_sess.graph.get_operation_by_name('Placeholder_2')
    output_op = build_sess.graph.get_operation_by_name('softmax/Softmax')
...
with tf.Session(graph=graph) as sess:
    build_saved_model(sess, '/output/path/saved_models/0')
